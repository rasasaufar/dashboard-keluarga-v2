...
// Replace names and normal strings (removed the global flag when not needed and adjusted matching)
page = page.replace(/Ahmad Arisandi/g, '{member.name}');
...
page = page.replace(
	/https:\/\/lh3\.googleusercontent\.com\/aida-public\/AB6AXuDXE5NDIiyYr30HtGo-7uuEPBOCg4Idjtl5k2u6qmU3gBeguBSJXWZdmZTL3l-aSZyeNBrGZ81r7tJfa44U0OdQM3XQ1jOeCfigx7viYnNpR1QcISIcMbMORgH8FnV63mew9nEyfsNMyH1LD03c31sueAu_Ruu4j6PL7v_DFCz0zd2JvORemImbj6xDJRk76ehkJkSrsnehk0dRQ4-2SyK628S1q7r5eskPzwsP41qTCOt2NRYqYDik8MshVaYNtDGaynzMAGMFiwA/g,
	'{member.image}'
);
...
`;
	// Find the end div of timeline correctly
...
`;
	// Make sure we have the correct html block closures
